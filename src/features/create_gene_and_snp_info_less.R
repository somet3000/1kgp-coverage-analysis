...
write.table(genes, 'data/out/less_coverage/gene_info.txt', sep = '\t', row.names = FALSE)
...
genotype.matrix <- read.table('data/out/less_coverage/matrix_eqtl_genotype_data.txt', row.names = NULL)
...
write.table(snp.df, 'data/out/less_coverage/snp_info.txt', sep = '\t', row.names = FALSE)
